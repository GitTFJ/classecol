...
## Nature classifier
The environment classifier 'nat_class()' works best with twitter data after a full clean and also requires sentiment analysis on the text.
```{r, warning = FALSE, error = FALSE, message = FALSE}
df = data.frame(
  text = c(
